...
YOU SHOULD IMPORT the file if you wanna use the grab user id function:         gather_user_ids_covid(day-of-month)
"""
twitter_api = tc.oauth_login()

#filter tweets by location: defined as syracuse university 
def gather_user_ids_covid(day):#input should be yearmonthdate example 2021 Jan 21st should be gather_user_id(21) 
